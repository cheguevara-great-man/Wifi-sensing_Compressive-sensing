...
folder_name = "UT_HAR_Randomdown_Upnearst_ResNet50"
...
def train(model, tensor_loader, num_epochs, learning_rate, criterion, device):
    ...
    for epoch in range(num_epochs):
        ...
        torch.save(model.state_dict(), os.path.join(log_path, folder_name, '{}_Randomdown_Upnearst_ResNet50_MODEL.pth'.format(epoch + 1)))
...
def main():
    ...
    test(
        ...
        save_metrics_path='./Val/UT_HAR_Randomdown_Upnearst_ResNet50/test_metrics.txt'
        )
    return
