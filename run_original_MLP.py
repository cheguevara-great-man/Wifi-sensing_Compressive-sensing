...
def train(model, tensor_loader, num_epochs, learning_rate, criterion, device):
    ...
    for epoch in range(num_epochs):
        ...
        torch.save(model.state_dict(), os.path.join(log_path, folder_name, '{}_original_MLP_MODEL.pth'.format(epoch + 1)))
...
def main():
    ...
    parser.add_argument('--model', choices = ['MLP','LeNet','ResNet18','ResNet50','ResNet101','RNN','GRU','LSTM','BiLSTM', 'CNN+GRU','ViT','EfficientNet'], default='MLP')
    ...
    test(
        ...
        criterion=criterion,
        device= device,
        checkpoint_path='./checkpoints/UT_HAR_original_MLP/67_original_MLP_MODEL.pth',
