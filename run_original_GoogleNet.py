...
folder_name = "UT_HAR_original_GoogleNet"
...
def train(model, tensor_loader, num_epochs, learning_rate, criterion, device):
    ...
    for epoch in range(num_epochs):
        ...
        torch.save(model.state_dict(), os.path.join(log_path, folder_name, '{}_original_GoogleNet_MODEL.pth'.format(epoch + 1)))
...
def main():
    ...
    parser.add_argument('--model', choices = ['MLP','LeNet','ResNet18','ResNet50','ResNet101','RNN','GRU','LSTM','BiLSTM', 'CNN+GRU','ViT','shuffleNet','AlexNet','GoogleNet'], default='GoogleNet')
    ...
    test(
        ...
        criterion=criterion,
        device= device,
        checkpoint_path='./checkpoints/UT_HAR_original_GoogleNet/67_original_GoogleNet_MODEL.pth',
        save_metrics_path='./Val/UT_HAR_original_GoogleNet/test_metrics.txt'
        )
    return
